...
class LangGraphServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.StreamChat = channel.unary_stream(
                '/chatbot.LangGraphService/StreamChat',
...
class LangGraphServiceServicer:
    ...
    def StreamChat(self, request, context):
        """Lưu ý từ khóa "stream" ở kết quả trả về
        """
...
def add_LangGraphServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chatbot.LangGraphService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chatbot.LangGraphService', rpc_method_handlers)
